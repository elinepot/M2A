...
EMBEDDING_SIZE = 50
word2id, embeddings, folder_train, folder_test = get_imdb_data(EMBEDDING_SIZE)
...
class Model(nn.Module):
    def __init__(self, INPUT_DIM, NUM_CLASSES, HIDDEN_SIZE):
        super().__init__()
        ...
        self.model = nn.Sequential(nn.Linear(self.INPUT_DIM, self.HIDDEN_LAYER),
                nn.ReLU())
